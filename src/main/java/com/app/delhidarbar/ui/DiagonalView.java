...
import static com.app.delhidarbar.ui.Squint.DIRECTIONS;
import static com.app.delhidarbar.ui.Squint.GRAVITIES;
...
public class DiagonalView extends ImageView {
    ...
    private Squint.Gravity gravity = Squint.Gravity.BOTTOM;
    private Squint.Direction direction = Squint.Direction.LEFT_TO_RIGHT;
    ...
    public void setDiagonalGravity(Squint.Gravity gravity) {
        this.gravity = gravity;
        invalidate();
    }

    public void setDiagonalDirection(Squint.Direction direction) {
